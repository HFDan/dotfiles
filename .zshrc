...
export PATH=$PATH:"$HOME/.pub-cache/bin":"$HOME/.cargo/bin":"$HOME/.local/bin/":"$HOME/.local/share/JetBrains/Toolbox/scripts"
...
plugins=(colored-man-pages git zsh-autosuggestions zsh-syntax-highlighting virtualenv dotnet)
